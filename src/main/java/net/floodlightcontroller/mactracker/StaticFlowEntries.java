...
class StaticFlowEntries {
    ...
    static final String GOTO_TABLE_1 = String.format(
    ...
    static final String GOTO_TABLE_2 = String.format(
            StaticFlowEntryConstants.GOTO_TABLE_FLOW, StaticFlowEntryConstants.CIENA_SWITCH_ID,
    ...
    static final String GOTO_TABLE_3 = String.format(
            StaticFlowEntryConstants.GOTO_TABLE_FLOW, StaticFlowEntryConstants.CIENA_SWITCH_ID,
    ...
    static final String GOTO_TABLE_4 = String.format(
            StaticFlowEntryConstants.GOTO_TABLE_FLOW, StaticFlowEntryConstants.CIENA_SWITCH_ID,
    ...
    static final String GOTO_TABLE_5 = String.format(
            StaticFlowEntryConstants.GOTO_TABLE_FLOW, StaticFlowEntryConstants.CIENA_SWITCH_ID,
    ...
    static final String GOTO_TABLE_6 = String.format(
            StaticFlowEntryConstants.GOTO_TABLE_FLOW, StaticFlowEntryConstants.CIENA_SWITCH_ID,
    ...
    static final String DROP_AT_T1 = String.format(
    ...
    static final String DROP_AT_T2 = String.format(
            StaticFlowEntryConstants.DROP_PACKET_FLOW, StaticFlowEntryConstants.CIENA_SWITCH_ID,
    ...
    static final String DROP_AT_T3 = String.format(
            StaticFlowEntryConstants.DROP_PACKET_FLOW, StaticFlowEntryConstants.CIENA_SWITCH_ID,
    ...
    static final String DROP_AT_T4 = String.format(
            StaticFlowEntryConstants.DROP_PACKET_FLOW, StaticFlowEntryConstants.CIENA_SWITCH_ID,
    ...
    static final String DROP_AT_T5 = String.format(
            StaticFlowEntryConstants.DROP_PACKET_FLOW, StaticFlowEntryConstants.CIENA_SWITCH_ID,
    ...
    static final String DROP_AT_T6 = String.format(
            StaticFlowEntryConstants.DROP_PACKET_FLOW, StaticFlowEntryConstants.CIENA_SWITCH_ID,
    ...
    static final String ALLOW_C1_C2 = String.format(StaticFlowEntryConstants.ALLOW_FLOW,
    ...
    static final String ALLOW_C2_C1 = String.format(StaticFlowEntryConstants.ALLOW_FLOW,
    ...
    static final String ALLOW_C2_C3 = String.format(StaticFlowEntryConstants.ALLOW_FLOW,
    ...
    static final String ALLOW_C3_C2 = String.format(StaticFlowEntryConstants.ALLOW_FLOW,
    ...
    static final String ALLOW_C4_C5 = String.format(StaticFlowEntryConstants.ALLOW_FLOW,
    ...
    static final String ALLOW_C5_C4 = String.format(StaticFlowEntryConstants.ALLOW_FLOW,
    ...
    static final String ALLOW_C5_C6 = String.format(StaticFlowEntryConstants.ALLOW_FLOW,
    ...
    static final String ALLOW_C6_C5 = String.format(StaticFlowEntryConstants.ALLOW_FLOW,
    ...
    static final String NORMAL_FLOW_MODE = String.format(
